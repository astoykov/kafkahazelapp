...
@Component
@Scope("prototype")
public class MyJsonMapLoader implements com.hazelcast.core.MapLoader<Integer, HazelcastJsonValue> {

	private static final Logger log =
            LoggerFactory.getLogger(MyJsonMapLoader.class);
    ...
    public Iterable<Integer> loadAllKeys() {
        ...
        System.out.println("loadAllKeys() -> {}"+ (ids == null ? ids : ids.size()));
